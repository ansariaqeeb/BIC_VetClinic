...
namespace DataModel
{
    static public class DBXML
    {
        ...
        static public XDocument ST_Invoice_C(string FLAG, int MID, string INVCNUMB, DateTime INVCDATE, int JOBID, string VOYAGENO, string VESSEL, DateTime ETA, DateTime ETD, int CUSTOMERID, string CUSTOMER, string ADDRESSDESC, string CURRENCY, decimal CONVRATE, int USERID, int MENUID, XElement TRANSXML, XElement LOGXML)
        {
            XElement MAINXML = new XElement("SPXML",
           new XElement("SPDETAILS",
           new XAttribute("FLAG", FLAG),
        ...
        static public XDocument st_AgencyFeeInvoice_C(string FLAG, int MID, string INVCNUMB, DateTime INVCDATE, int JOBID, string VOYAGENO, string VESSELTYPE, DateTime AADATE, DateTime ADDATE, int CUSTOMERID, string CUSTOMER, string ADDRESSDESC, string CURRENCY, int USERID, int MENUID, XElement TRANSXML, XElement LOGXML)
        {
            XElement MAINXML = new XElement("SPXML",
           new XElement("SPDETAILS",
           new XAttribute("FLAG", FLAG),
        ...
        static public XDocument ST_InvoiceTrans_C(string FLAG, int TID, int RMID, DateTime TRANSDATE, int ITEMID, int DAYTYPE, string ITEMDESC, bool ISOVERTIME, decimal QTY1, string UOM1, decimal QTY2, string UOM2, decimal RATE, decimal TAX, decimal TAXAMOUNT, decimal AMOUNT, string REMARK,
       ...
       decimal DAYTYPE1MINCHARGE, decimal DAYTYPE2MINCHARGE, decimal DAYTYPE3MINCHARGE, decimal DAYTYPE4MINCHARGE, decimal DAYTYPE1RATE, decimal DAYTYPE2RATE, decimal DAYTYPE3RATE, decimal DAYTYPE4RATE, int USERID, int MENUID, XElement LOGXML)
        ...
        static public XDocument dbConfig_g(int dbConfigId, string dbName, int userId, XElement LOGXML)
        {
            XElement MAINXML = new XElement("SPXML",
           new XElement("SPDETAILS",
